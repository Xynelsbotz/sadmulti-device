...
let handler = async (m, { conn, usedPrefix: _p }) => {
  try {
   ...
   conn.sendButton(m.chat, `_${wish()}, ${name} 👋_`, text.trim(), await genProfile(conn, m), [['Speedtest', _p + 'ping'], ['Owner', _p + 'owner']], false, { quoted: fkon, contextInfo: { externalAdReply: { showAdAttribution: true,
    mediaUrl: "https://Instagram.com/xynels.design",
    mediaType: "VIDEO",
    description: "https://Instagram.com/bot_whangsaf", 
    title: 'BOT WHATSAPP SAYU OGIWARA',
    body: wm,
    thumbnail: thumb,
    sourceUrl: sgc
}
